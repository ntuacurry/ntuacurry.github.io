...
const foodSafetyData = {
    "乳及乳製品類": {
      "items": [
        ...
        {
          "name": "乾酪(Cheese)、奶油(Butter)及乳脂(Cream)",
          "standards": [
    ...
    "嬰兒食品類": {
      "items": [
        ...
        {
          "name": "本表第2.5項所列罐頭食品以外之其他專供嬰兒食用之副食品",
          "standards": [
        ...
        {
          "name": "罐頭食品：其他供直接食用之嬰兒罐頭食品，如：液態即食配方奶、肉泥、水果泥、蔬菜泥等",
          "standards": [
            { "microbe": "保溫試驗", "sampling": "", "limit": "經保溫試驗(37℃，10天)檢查合格：沒有因微生物繁殖而導致產品膨罐、變形或pH值異常改變等情形。" }
          ]
        }
    ...
    "包裝/盛裝飲用水及飲料類": {
      "items": [
        ...
        {
          "name": "含碳酸之飲料(如：汽水、可樂及其他添加碳酸之含糖飲料)",
          "standards": [
            { "microbe": "腸桿菌科", "sampling": "", "limit": "陰性" }
          ]
        },
        {
          "name": "本表第4.7及4.8項所列種類以外之其他還原果蔬汁、果蔬汁飲料、果漿(蜜)及其他類似製品",
          "standards": [
            { "microbe": "腸桿菌科", "sampling": "", "limit": "陰性" }
          ]
        },
        {
          "name": "本表第4.7及4.8項所列種類以外之其他以食品原料萃取而得之飲料(包括咖啡、可可、茶或以穀物、豆類等原料萃取、磨製而成，供飲用之飲料)",
          "standards": [
            { "microbe": "腸桿菌科", "sampling": "", "limit": "陰性" }
          ]
        },
        {
          "name": "未經商業殺菌之鮮榨果蔬汁、添加少於50 %乳品且未經商業殺菌之含乳鮮榨果蔬汁",
          "standards": [
        ...
        {
          "name": "本表第4.7項所列種類以外之其他發酵果蔬汁(飲料)、添加乳酸調味之酸性飲料、添加發酵液(含活性益生菌)之飲料",
          "standards": [
            { "microbe": "腸桿菌科", "sampling": "", "limit": "陰性" }
          ]
        },
        {
          "name": "本表第4.5項所列種類以外之其他即時調製、未經殺菌處理，且架售期少於24小時之飲料",
          "standards": [
    ...
    "冷凍食品及冰類": {
      "items": [
        ...
        {
          "name": "冷凍即食食品，包括:-冰品，如:冰淇淋、義式冰淇淋、冰棒、刨冰、聖代、雪酪、冰沙等-冷凍水果",
          "standards": [
            { "microbe": "腸桿菌科", "sampling": "", "limit": "10 CFU/g (mL)" },
            { "microbe": "沙門氏菌", "sampling": "", "limit": "陰性" }
          ]
        ...
        {
          "name": "本表第5.6項所列種類以外之其他經加熱煮熟後再冷凍之食品，僅需解凍或復熱即可食用者，包括:-冷凍熟蔬菜",
          "standards": [
            { "microbe": "腸桿菌科", "sampling": "", "limit": "10 CFU/g (mL)" },
            { "microbe": "沙門氏菌", "sampling": "", "limit": "陰性" }
          ]
        ...
        {
          "name": "冷凍非即食食品-須再經加熱煮熟始得食用之冷凍食品-非供生食之冷凍生鮮水產品",
          "standards": [
        ...
        {
          "name": "經加熱煮熟後再冷凍之水產品，僅需解凍或復熱即可食用者",
          "standards": [
            { "microbe": "沙門氏菌", "sampling": "", "limit": "陰性" },
    ...
    "其他即食食品類": {
      "items": [
        {
          "name": "本表第1類至第5類食品所列以外之其他經復水或沖調即可食用之食品",
          "standards": [
        ...
        {
          "name": "本表第1類至第5類食品所列以外之其他即食食品，以常溫或熱藏保存者",
          "standards": [
            { "microbe": "金黃色葡萄球菌", "sampling": "", "limit": "100 CFU/g (mL)" },
            { "microbe": "沙門氏菌", "sampling": "", "limit": "陰性" },
            { "microbe": "單核球增多性李斯特菌", "sampling": "", "limit": "100 CFU /g (mL)" }
        ...
        {
          "name": "本表第1類至第5類食品所列以外之其他即食食品，以冷藏或低溫保存者，包括：-經復熱後即可食用之冷藏或低溫即食食品(如:18℃鮮食)-冷藏甜點、醬料等",
          "standards": [
            { "microbe": "金黃色葡萄球菌", "sampling": "", "limit": "100 CFU/g (mL)" },
            { "microbe": "沙門氏菌", "sampling": "", "limit": "陰性" },
            { "microbe": "單核球增多性李斯特菌", "sampling": "", "limit": "100 CFU /g (mL)" }
